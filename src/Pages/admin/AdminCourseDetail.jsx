  ...
  const fetchCourseData = async () => {
    try {
      ...
      const courseRes = await axios.get(
        `http://localhost:5000/api/courses/slug/${courseId}`
      );
      ...
      const videosRes = await axios.get(
        `http://localhost:5000/api/videos/course/${courseData._id}`
      );
      ...
      const testPromises = videosList.map(async (video) => {
        try {
          const response = await axios.get(
            `http://localhost:5000/api/tests/video/${video._id}`
          );
          if (response.data) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-blue-50">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-8 py-3 rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all shadow-lg hover:shadow-xl"
          >
